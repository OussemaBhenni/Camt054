...
/**
 * <p>Classe Java pour ReportEntry10 complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="NtryRef" type="{urn:iso:std:iso:20022:tech:xsd:camt.054.001.08}Max35Text" minOccurs="0"/>
 ...
 *         &lt;element name="BookgDt" type="{urn:iso:std:iso:20022:tech:xsd:camt.054.001.08}DateAndDateTime2Choice" minOccurs="0"/>
 *         &lt;element name="ValDt" type="{urn:iso:std:iso:20022:tech:xsd:camt.054.001.08}DateAndDateTime2Choice" minOccurs="0"/>
 ...
 *         &lt;element name="AddtlInfInd" type="{urn:iso:std:iso:20022:tech:xsd:camt.054.001.08}MessageIdentification2" minOccurs="0"/>
 ...
 *         &lt;element name="TechInptChanl" type="{urn:iso:std:iso:20022:tech:xsd:camt.054.001.08}TechnicalInputChannel1Choice" minOccurs="0"/>
 *         &lt;element name="Intrst" type="{urn:iso:std:iso:20022:tech:xsd:camt.054.001.08}TransactionInterest4" minOccurs="0"/>
 *         &lt;element name="CardTx" type="{urn:iso:std:iso:20022:tech:xsd:camt.054.001.08}CardEntry4" minOccurs="0"/>
 *         &lt;element name="NtryDtls" type="{urn:iso:std:iso:20022:tech:xsd:camt.054.001.08}EntryDetails9" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="AddtlNtryInf" type="{urn:iso:std:iso:20022:tech:xsd:camt.054.001.08}Max500Text" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ReportEntry10 {
    ...
    /**
     * Obtient la valeur de la propri�t� ntryRef.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * D�finit la valeur de la propri�t� ntryRef.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
    ...
    /**
     * Obtient la valeur de la propri�t� rvslInd.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * D�finit la valeur de la propri�t� rvslInd.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
    ...
    /**
     * Obtient la valeur de la propri�t� valDt.
     * 
     * @return
     *     possible object is
     *     {@link DateAndDateTime2Choice }
    ...
    /**
     * D�finit la valeur de la propri�t� valDt.
     * 
     * @param value
     *     allowed object is
     *     {@link DateAndDateTime2Choice }
    ...
    /**
     * Obtient la valeur de la propri�t� comssnWvrInd.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * D�finit la valeur de la propri�t� comssnWvrInd.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
    ...
    /**
     * Obtient la valeur de la propri�t� addtlInfInd.
     * 
     * @return
     *     possible object is
    ...
    /**
     * D�finit la valeur de la propri�t� addtlInfInd.
     * 
     * @param value
     *     allowed object is
     *     {@link MessageIdentification2 }
    ...
    /**
     * Obtient la valeur de la propri�t� techInptChanl.
     * 
     * @return
     *     possible object is
    ...
    /**
     * D�finit la valeur de la propri�t� techInptChanl.
     * 
     * @param value
     *     allowed object is
     *     {@link TechnicalInputChannel1Choice }
    ...
    /**
     * Obtient la valeur de la propri�t� addtlNtryInf.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * D�finit la valeur de la propri�t� addtlNtryInf.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
